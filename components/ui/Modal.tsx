          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <DialogPrimitive.Close
                autoFocus
                className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-foreground focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground"
              >
                <X className="h-4 w-4" />
...
interface ModalProps {
  ...
  open: boolean;
  /** Called when the modal is dismissed (close button or backdrop click). */
  onClose: () => void;
