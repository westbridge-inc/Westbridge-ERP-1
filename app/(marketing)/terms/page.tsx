    ...
    <div className="mx-auto max-w-3xl bg-background px-6 py-16">
      ...
      <div className="mt-10 space-y-8 text-base text-muted-foreground">
        ...
        <section>
          ...
          <p className="mt-2 leading-relaxed">
            Subscription fees are billed in advance according to your selected plan. Payment is processed via Paddle,
            our payment provider. Refunds are handled in accordance with our refund policy and applicable law. We may
            change pricing with reasonable notice; continued use after changes constitutes acceptance.
          </p>
        </section>
        <section>
