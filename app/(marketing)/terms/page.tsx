      ...
      <div className="mt-10 space-y-8 text-base text-muted-foreground">
        <section>
          ...
          <p className="mt-2 leading-relaxed">
            By signing up for or using Westbridge (&quot;Service&quot;), you agree to these Terms of Service. Westbridge
            is a business management platform. If you are using the Service on behalf of a company, you represent that
        ...
        <section>
          ...
          <p className="mt-2 leading-relaxed">
            You will use the Service only for lawful business purposes. You are responsible for maintaining the security
            of your account and for all activity under your account. You will not attempt to gain unauthorized access to
            the Service, other accounts, or our systems.
          </p>
        </section>
        <section>
          <h2 className="text-base font-semibold text-foreground">3. Payment and Subscription</h2>
          <p className="mt-2 leading-relaxed">
            Subscription fees are billed in advance according to your selected plan. Payment is processed via WiPay, a
            Caribbean payment gateway. Refunds are handled in accordance with our refund policy and applicable law. We
            may change pricing with reasonable notice; continued use after changes constitutes acceptance.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p className="mt-2 leading-relaxed">
            You may cancel your subscription at any time. We may suspend or terminate your access for breach of these
            Terms, non-payment, or for operational or legal reasons, with notice where practicable.
          </p>
        </section>
        <section>
          <h2 className="text-base font-semibold text-foreground">6. Limitation of Liability</h2>
          <p className="mt-2 leading-relaxed">
            To the maximum extent permitted by law, Westbridge and its providers shall not be liable for indirect,
            incidental, special, or consequential damages, or for loss of data or business interruption arising from
